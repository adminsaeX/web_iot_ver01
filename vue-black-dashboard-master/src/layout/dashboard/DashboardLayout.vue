<template>
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        <sidebar-link to="/home" :name="$t('หน้าหลัก')" icon="tim-icons icon-chart-pie-36"/>
        <sidebar-link to="/icons" :name="$t('รายงานสถานะ')" icon="tim-icons icon-atom"/>
        <sidebar-link to="/maps" :name="$t('พิกัด')" icon="tim-icons icon-pin"/>
        <sidebar-link to="/notifications" :name="$t('รายงานแจ้งเตือน')" icon="tim-icons icon-bell-55"/>
       <!-- <sidebar-link to="/profile" :name="$t('sidebar.userProfile')" icon="tim-icons icon-single-02"/>
        ...
        <sidebar-link to="/home" :name="$t('home2')" icon="tim-icons icon-align-left-2"/>-->
      </template>
    </side-bar>
